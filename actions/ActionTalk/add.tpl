...
<form action="" method="post" enctype="multipart/form-data">
        <div>
			...
			<input type="submit" class="button" value="{$aLang.topic_create_submit_preview}" name="submit_preview" onclick="jQuery('#text_preview').parent().show(); ls.tools.textPreview('talk_text',false); return false;" />&nbsp;
        </div>
</form>
