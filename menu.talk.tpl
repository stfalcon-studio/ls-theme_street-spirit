...
<ul class="nav nav-pills">					
	...
	<li {if $sMenuSubItemSelect=='favourites'}class="active"{/if}><a href="{router page='talk'}favourites/">{$aLang.talk_menu_inbox_favourites}{if $iCountTalkFavourite} <sup>{$iCountTalkFavourite}</sup>{/if}</a></li>
