	...
	<footer class="topic-footer">
		...
		<ul class="topic-info">
			...
			<li class="topic-info-share" data-topic-id="{$oTopic->getId()}" onclick="jQuery('#topic_share_{$oTopic->getId()}').slideToggle(); return false;"><i class="icon-synio-share-blue" title="{$aLang.topic_share}"></i><span>{$aLang.topic_share}</span></li>
